...
typedef struct Querier_vtable {
  ...
  int32_t (*get_call_info)(const struct querier_t*, uint64_t*, struct U8SliceView, struct U8SliceView, struct UnmanagedVector*, struct Db**, struct GoQuerier**, struct UnmanagedVector*);
